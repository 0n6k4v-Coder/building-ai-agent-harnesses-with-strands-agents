...
SYSTEM_INSTRUCTION = (
    ...
    "   - To view changes: `git diff`\n"
    "   - To commit: `git add . && git commit -m \"<descriptive message>\"`\n"
    "   - To push: `git push`\n"
    "4. The commit message MUST be a human-readable description of the change. NEVER pass the words 'push', 'commit', or 'approve' as the commit message.\n"
